          ...
          <div className="flex flex-col gap-5">
            <div className='flex gap-6'>
              <div className='flex flex-col'>
                ...
                <Input type="text" id="first-name" name="first-name"  onChange={testClick} required className="bg-gray-100 rounded-md p-2 " />
              </div>
              <div className='flex flex-col '>
                <Label htmlFor="last-name"className="text-sm font-light">Last Name<span className='text-red-600'>*</span></Label>
                <Input type="text" id="last-name" name="last-name"  onChange={testClick} className="bg-gray-100 rounded-md p-2 w-full" required />
              </div>
            </div>
            <div>
              <Label htmlFor="email"className="text-sm font-light">Business Email<span className='text-red-600'>*</span></Label>
              <Input type="email" id="email" name="email"  onChange={testClick} className="bg-gray-100 rounded-md p-2 w-full"  required />
            </div>
            <div>
              <Label htmlFor="message"className="text-sm font-light">Message<span className='text-red-600'>*</span></Label>
              <Textarea id="message" name="message"  onChange={testClick} className="bg-gray-100 rounded-md p-2 w-full" required rows={5} />
            </div>
            <div>
              <Label htmlFor="contact"className="text-sm font-light">Contact Number<span className='text-red-600'>*</span></Label>
              <div className='flex gap-4'>
                <Input type="" id="contact" name="contact"  onChange={testClick} className="bg-gray-100 rounded-md p-2 max-w-20" placeholder="+234" disabled required />
                <Input type="" id="contact" name="contact"  onChange={testClick} className="bg-gray-100 rounded-md p-2 w-full"  required />
              </div>
            </div>
