        ...
        <>
            <main className="flex-1 mt-6">
                ...
                <section className="flex mt-5 ">
                    ...
                    <div className=" bg-cyan-700 flex flex-col gap-2 pl-32 pr-10 pt-16 pb-12 shadow-lg mt-8 mb-8 rounded-r-md">
                ...
                <section
                    id="products"
                    className="w-full px-10 py-12 md:py-24 lg:py-32" >
                    <div className="container px-4 md:px-6">
                        ...
                        <div className="flex flex-col md:flex-row gap-1 items-center px-2 w-fit border-2 border-gray-600 rounded-full py-2 ">
                            <Button
                                href="#"
                                onClick={testClick}
                                type="submit"
                        ...
                        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 text-center">
                            <div className="space-y-4 flex flex-col p-4 hover:scale-105">
                                <div className="flex flex-col gap-4 bg-gray-100 px-4 rounded-lg ring-4 ring-white shadow-lg ring-offset-0 h-[300px]">
                                    ...
                                    <p className="text-xs text-gray-600">
                                        The quickest and easiest way to create branded short links.
                                    </p>
                        ...
                        <div className="space-y-4 flec flex-col hover:scale-105 p-4">
                            <div className="flex flex-col gap-4 bg-cyan-100 px-4 rounded-lg ring-4 ring-white shadow-lg ring-offset-0 h-[300px]">
                                ...
                                <p className="text-xs text-gray-600">
                                    Advanced features to boost performance and scale your
                                    business.
                                </p>
                                <p className="text-gray-600">
                        ...
                        <div className="mt-12 max-w-md mx-auto">
                            <form className="grid gap-4">
                                ...
                                <Button
                                    ...
                                    className="w-full border bg-white p-2 rounded-lg text-gray-600 font-bold"
                                >
                                    Submit
                                </Button>
                            </form>
